...
public class BarGraph : MonoBehaviour
{
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        BarTransform.localScale = new Vector3(value, BarTransform.localScale.y, BarTransform.localScale.z);
    ...
    public static BarGraph Find(string name, Vector2 position, float min, float max)
    {
        ...
        if (BarGraphTable.TryGetValue(name, out BarGraph existingBarGraph)) {
            return existingBarGraph;
        }
        //
